...
// NewSubrouter - Creates and returns a new subrouter
...
// SetNotfoundHandler - Attaches not found handler for the router
func (router *Router) SetNotfoundHandler(nf func(http.ResponseWriter, *http.Request)) {
	router.notfoundHandler = nf
}

// GetHandler - Returns the handler for the router
